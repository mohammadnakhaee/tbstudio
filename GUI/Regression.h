...
public:
    ...
    void lm(double* p, int np, double* t, double* y_dat, int ny, double* weight, double* dp, double p_min, double p_max, double* c, lmOptions opts, double &redX2, double* sigma_p, double** cvg_hst, bool isOneStep, lapack_complex_double* UpperSymMatrixHf, lapack_complex_double* UpperSymMatrixSf, double* eigHf, int natoms, bool isSOC, bool isOverlap);
    void lm_FD_J(double* t, double* p, int np, double* y, int ny, double* dp, double* c, double** J, int &func_calls, lapack_complex_double* UpperSymMatrixHf, lapack_complex_double* UpperSymMatrixSf, double* eigHf, int natoms, bool isSOC, bool isOverlap);
    void lm_Broyden_J(double* p_old, double* y_old, double** J, double* p, int np, double* y, int ny);
    void lm_matx(double* t,double* p_old, int np, double* y_old, int ny, double dX2, double** J, double* p, double* y_dat, double* weight, double* dp, double* c, double** JtWJ, double* JtWdy, double Chi_sq, double* y_hat, int &func_calls, int &iteration, lapack_complex_double* UpperSymMatrixHf, lapack_complex_double* UpperSymMatrixSf, double* eigHf, int natoms, bool isSOC, bool isOverlap);
